...
\begin{enumerate}
	...
	\item On répète le processus pour des \og villages\fg{}, peuplés eux d'une dizaine\footref{ftn:nombre-parametrable} de foyers paysans.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\linewidth]{img/init_fp.pdf}
...
Pour l'initialisation, les paramètres sur lesquels on peut jouer pour tester différents scénarios sont les suivants (\cref{tab:params-initiaux}).
...
\begin{table}[H]
	...
	\begin{tabular}{|M{2cm}|M{4cm}|m{5.25cm}|m{1.25cm}|}
		...
		& \makecell{Puissance relatives\\des Grands Seigneurs} & \makecell{puissance\_grand\_seigneur1 \\ \textelp{} \\ puissance\_grand\_seigneur$N$} & 50\% \\ \cline{2-4} 
...
\textit{De 800 à 960, les églises doivent se situer entre 5 et 25km, puis entre 3 et 10km jusqu'en 1060, et entre 1.5 et 5km après cette date.}}, captionpos=b, label={lst:maps-gama}]
...
Encadré sur la polarité d'implémentation : \Cref{enc:polarite-implementation}

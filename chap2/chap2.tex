...
\begin{itemize}
	...
	\item 27/10/2019 : reprises texte + figures
\end{itemize}
...
Dans un souci de généricité il a donc été décidé d'intégrer la construction de la situation initiale en tant que première étape du modèle.
...
+ modèle KIDS, avec beaucoup d'hétérogénéité dans le niveau de précision des différents mécanismes, mais malgré tout, une certaine généricité dans les manières de concevoir ces mécanismes, qui peuvent être spécifiés après. \\
cf. commentaire Lena :
\begin{quotation}
\noindent\og beaucoup de similitudes dans les fonctionnements de ces deux mécanismes.\\
Ils auraient pu être présentés de manière plus générique. Je ne te demande pas de le faire ici, mais cela pourrait, soit en conclusion de ce §, soit à un autre endroit, donner lieu à une petite discussions sur le généricité de ces mécanismes et les manières de les appliquer à des cas empiriques précis.\\
religieux + protection : très générique\\
périodes et renforcement du religieux = particulier
\fg{}\\
\hfill Lena, 15/08/2019, satisfactions religieuses et protection (2.3.6)
\end{quotation}

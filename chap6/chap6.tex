...
\vfill
% TODO : A réactiver dans version finale
\setstretch{1.5}
\minitoc
\setstretch{1.1}
\clearpage
...
\subsection{Construction de connaissance par l'exploration visuelle d'un modèle \label{subsec:construction-connaissance-explo}}

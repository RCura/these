	...
	Si l'on a déjà mentionné des objectifs dans le chapitre précédent (\hl{ref. chap. 2)}
...
\subsection{Indices et indicateurs}
		...
		Ajuster le chapeau introductif pour prendre en compte tout ce qui vient après.
		\vskip5pt
	}
}
\bigskip

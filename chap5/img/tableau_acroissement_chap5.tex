...
\caption{Synthèse des questionnements liés à l'exploration de données issues de modèle et de la multiplication des données et indicateurs selon la hiérarchie des simulations.}

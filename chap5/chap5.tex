...
\begin{center}
	...
	\hl{Corrections de la partie 5.2 à 5.2.3 non prises en compte.}
...
\end{figure}
	...
	En sortie, on obtient une table synthétique et de nombreux graphiques (\hl{cf. schéma chap. 3}), dans des formats vectoriels, donc aisément modifiables, par exemple pour les adapter à différents publics, et surtout, lisibles et transférables très simplement.

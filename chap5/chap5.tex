...
\end{figure}
	...
	Pour être en mesure de comparer de nombreux éléments, il est nécessaire de passer d'une exploration linéaire, voyant défiler les indicateurs les uns après les autres, à une exploration globale et interactive.
	C'est-à-dire que plutôt que de voir se succéder des pages d'indicateurs, mieux vaut une interface présentant le points clefs de l'évaluation et permettant d'entrer dans le détail de chacun des indicateurs après-coup.

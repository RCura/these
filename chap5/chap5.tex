...
\begin{figure}[H]
	\centering
	\includegraphics[width=.95\linewidth]{img/sensib/sensibilite_periode_promotion_chateaux.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.95\linewidth]{img/sensib/sensibilite_nb_tirages_chateaux_ps.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.95\linewidth]{img/sensib/sensibilite_debut_construction_chateaux.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.95\linewidth]{img/sensib/sensibilite_ponderation_creation_paroisse_agregat.pdf}

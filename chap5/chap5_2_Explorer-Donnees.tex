...
\end{quote}
	...
	Plutôt que de présenter les indicateurs dans des pages successives, on a préféré les organiser au seins d'onglets.
	Chaque onglet concernait un type d'entité et présentait l'ensemble des indicateurs propres à ces entités \hl{Faire ref aux captures d'écrans qui seront ajoutées}.\\
	...
	Au niveau de l'interface utilisateur, SimVADB permettait de choisir, dans une liste déroulante, les expériences passées dont on voulait visualiser les indicateurs de sortie, à partir de leur nom \hl{cf. figure n}.

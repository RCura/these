...
Depuis la première plate-forme aboutie -- SimVADB (\cref{fig:simvadb_dashboard}, reprise ici en \cref{subfig:mini-simdavb}) --, l'interface graphique a, par conséquent, fortement évolué (\cref{subfig:mini-simedb}).

\begin{figure}[H]
	\centering
	\subfloat[SimVADB]{\label{subfig:mini-simdavb}\includegraphics[width=.95\linewidth]{img/SimVADB_Dashboard2_annote_retouche.png}}\\[-1.5ex]
	\hspace{1pt}
	\subfloat[SimEDB]{\label{subfig:mini-simedb}\includegraphics[width=.9\linewidth]{img/mockup_SimEDB.pdf}}
	\vspace{-0.25cm}
	\caption{Comparaison visuelle de SimVADB et SimEDB.}

...
%\vspace*{-3.5em}
\begin{center}
	{\large Version \hl{non définitive du 2019-12-16}}
\end{center}
%\vspace*{-2.5em}
%\begin{itemize}
...
\subsection{Des processus inscrits dans la longue durée \label{subsec:processus-longue-duree}}
...
\subsection[Position du modélisateur : du guide au con-constructeur]{Position du modélisateur : du guide au con-constructeur \label{subsec:position-modelisateur}}
...
\subsection{Une démarche reproductible \label{subsec:demarche-reproductible}}
